...
Use a subagent for:
- Searches (web, social, email, code)
- API calls
- Multi-step tasks
- Data processing
...
- All coding, debugging, and investigation tasks
...
- **Medium / Major:** Delegate to the coding agent CLI. This includes
...
- Keep the main session responsive so Kris can keep talking
...
When delegating to a subagent, tell Kris which model and provider
...
1. Report to Kris via messaging platform with error details
